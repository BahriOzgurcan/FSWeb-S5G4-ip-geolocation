...
ipAdresimiAl().then(function () {
  var apiPromise = _axios.default.get("https://apis.ergineer.com/ipgeoapi/" + benimIP);
  var weatherCard = function weatherCard(dataFromApi) {
    ...
    imgCard.setAttribute("src", "https://flagcdn.com/w320/".concat(dataFromApi["ülkeKodu"].toLowerCase(), ".png"));
    // imgCard.setAttribute("src", dataFromApi["ülkebayrağı"]);
    divInfo.classList.add("card-info");
    h3Card.className = "ip";
    h3Card.textContent = benimIP;
    pCountry.className = "ulke";
    pCountry.textContent = "".concat(dataFromApi["ülke"], " (").concat(dataFromApi["ülkeKodu"], ")");
    pLocation.textContent = "Enlem: ".concat(dataFromApi.enlem, "  Boylam: ").concat(dataFromApi.boylam, " ");
    pCity.textContent = "\u015Eehir: ".concat(dataFromApi["bölgeAdı"], " ");
    pTimezone.textContent = "Saat dilimi: ".concat(dataFromApi.saatdilimi, " ");
    pCurrency.textContent = "Para birimi: ".concat(dataFromApi.parabirimi);
    pISP.textContent = "ISP: ".concat(dataFromApi.isp);
